...
import { ActionList, Badge, BlockStack, Box, Button, Card, Collapsible, FormLayout, Icon, InlineGrid, InlineStack, Key, Layout, Link, Page, Popover, RadioButton, Select, Text, TextContainer, TextField } from "@shopify/polaris";
import { useCallback, useState} from "react";
import { ArrowDownIcon, CaretDownIcon, ChevronDownIcon, ExternalIcon, OrderIcon, PlusIcon} from '@shopify/polaris-icons';
...
export default function SinglePage({ pageName, settings, dispatch , children}: WidgetSettingProps) {
...
{/* {console.log(widgetStates , "retun")} */}
      ...
      //  titleMetadata={<ActionListInPopoverExample capitalizedPageName={capitalizedPageName} pageName={pageName}/>} 
       backAction={{ content: 'Back', onAction: () => navigate("/app/features") }} >
        <InlineGrid columns={isMobile ? 1 : showSlidekick ? { md: "5fr 2fr" } : 1} gap="200">
          <BlockStack gap={"500"}>
              ...
              <Card key={key}>
                <BlockStack gap="400">
                  ...
                  >
                    ...
                    <InlineGrid columns={isMobile ? 1 : showSlidekick ? 1 : settingKick} gap="400">                    
                      <Card>
                        <BlockStack gap="200">
